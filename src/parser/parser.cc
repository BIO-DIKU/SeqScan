...
#define YYCASE_(N, S)                         \
        ...
        YYCASE_(1, YY_("syntax: Unexpected %s"));
        YYCASE_(2, YY_("syntax: Unexpected %s, expecting %s"));
        YYCASE_(3, YY_("syntax: Unexpected %s, expecting %s or %s"));
        YYCASE_(4, YY_("syntax: Unexpected %s, expecting %s or %s or %s"));
        YYCASE_(5, YY_("syntax: Unexpected %s, expecting %s or %s or %s or %s"));
#undef YYCASE_
      }
