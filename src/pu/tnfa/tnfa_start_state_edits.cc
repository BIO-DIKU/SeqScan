...
TNFAStartStateEdits::TNFAStartStateEdits(uint64_t e) : TNFAStateEdits(0),
                                                       stateErrorCode_(e) {}

void TNFAStartStateEdits::addEpsilonTransitions(
    bool listNo,
    std::string::const_iterator pos,
    std::vector< TNFAStateEdits * > stateLists[],
...
void TNFAStartStateEdits::addOutStates(bool listNo,
                                       std::string::const_iterator pos,
                                       std::vector< TNFAStateEdits * > stateLists[],
                                       std::unordered_map<int, int> &matchMap,
                                       uint32_t listID)
...
void TNFAStartStateEdits::display(bool) {
