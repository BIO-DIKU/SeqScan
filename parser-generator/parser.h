...
#line 58 "parser.hh" // lalr1.cc:392
...
#line 37 "parser.y" // lalr1.cc:392
namespace  SeqScan  {
#line 135 "parser.hh" // lalr1.cc:392
  ...
  public:
    ...
    union union_type
    {
      // unit_list
      // punit
      char dummy1[sizeof( PTNode* )];

      // prefix_modifier
      char dummy2[sizeof( PTPreModifier* )];

      // suffix_modifier
      char dummy3[sizeof( PTSufModifier* )];
  ...
  basic_symbol (typename Base::kind_type t, const  PTNode*  v, const location_type& l);
  ...
  template <typename Base>
   Parser ::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const  PTNode*  v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
   ...
   Parser ::make_OR (const location_type& l)
  {
   ...
   Parser ::symbol_type
   Parser ::make_QMARK (const location_type& l)
  {
    return symbol_type (token::TOKEN_QMARK, l);
  }
...
#line 1266 "parser.hh" // lalr1.cc:392
