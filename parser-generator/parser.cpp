...
#line 53 "parser.cpp" // lalr1.cc:392


// First part of user declarations.

#line 58 "parser.cpp" // lalr1.cc:399
...
#line 72 "parser.cpp" // lalr1.cc:407
...
#line 37 "parser.y" // lalr1.cc:474
namespace  EzAquarii  {
#line 158 "parser.cpp" // lalr1.cc:474
      ...
      try
        {
          switch (yyn)
            {
  case 2:
#line 105 "parser.y" // lalr1.cc:847
    { 
    cout<<" ======= DONE ======"<<endl; 
    driver.set_parse_tree(yystack_[0].value.as<  PTNode*  > ());
}
#line 569 "parser.cpp" // lalr1.cc:847
    break;

  case 3:
#line 111 "parser.y" // lalr1.cc:847
    {
	cout<<"Parsing punit in list"<<endl;
    yystack_[2].value.as<  PTNode*  > ()->children_.push_back(yystack_[0].value.as<  PTNode*  > ());
	cout<<" .. adding child "<<yystack_[0].value.as<  PTNode*  > ()->str()<<endl;
	yylhs.value.as<  PTNode*  > () = yystack_[2].value.as<  PTNode*  > ();
	cout<<" .. returning "<<yylhs.value.as<  PTNode*  > ()->str()<<endl;
  }
#line 581 "parser.cpp" // lalr1.cc:847
    break;
...
#line 118 "parser.y" // lalr1.cc:847
    ...
    yylhs.value.as<  PTNode*  > () = new PTNode(PTNode::COMPOSITE);
	cout<<" .. adding child "<<yystack_[0].value.as<  PTNode*  > ()->str()<<endl;
	yylhs.value.as<  PTNode*  > ()->children_.push_back(yystack_[0].value.as<  PTNode*  > ());
	cout<<" .. returning "<<yylhs.value.as<  PTNode*  > ()->str()<<endl;
  }
#line 593 "parser.cpp" // lalr1.cc:847
    break;

  case 5:
#line 128 "parser.y" // lalr1.cc:847
    {
    cout<<"Parsing sequence "<<yystack_[0].value.as< std::string > ()<<endl;
...
#line 602 "parser.cpp" // lalr1.cc:847
  ...
  case 6:
#line 132 "parser.y" // lalr1.cc:847
    {
...
#line 615 "parser.cpp" // lalr1.cc:847
            default:
              break;
            }
        }
...
#undef YYCASE_
  ...
  "\"leftpar\"", "\"rightpar\"", "\"space\"", "$accept", "pattern",
  "unit_list", "punit", YY_NULLPTR
  };
...
#line 37 "parser.y" // lalr1.cc:1155
} //  EzAquarii 
#line 982 "parser.cpp" // lalr1.cc:1155
#line 139 "parser.y" // lalr1.cc:1156
